...
const Hero = () => {
  ...
  return (
    <div className='h-full w-full flex flex-col items-center md:p-3 pt-7 bg-cream'>
        ...
        <p  className='md:text-xl font-semibold font-mono md:pb-[2vw] p-5'> Let's identify the <span className='text-pink-900'>Model</span> & <span className='text-pink-900'>simulate</span> the World..</p>
